...
//Function Create
function Create() {
    //Declaring the Varaible and getting data from the URL
    ...
    function handleSubmit(event) {
        ...
        axios.post('http://localhost:8081/dashboard/bookings/new', {fullname: username, atcposition, date, starttime, endtime})
        .then(res => {
            console.log(res);
            navigate('/dashboard');
        })
 ...
 <link
            ...
            {alert}
                ...
                <p className="mb-4">Create a new ATC Booking</p>
